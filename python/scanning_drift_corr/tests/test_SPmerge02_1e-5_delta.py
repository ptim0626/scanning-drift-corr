...
def test_initial_alignment_1en5_delta(MATLAB_simulated_images):
    ...
    mfile = 'SPmerge02_initial_alignment_simulated_0_90_1en5_delta.mat'
...
def test_final_alignment_NO_global_phase_corr_1en5_delta(MATLAB_simulated_images):
...
def test_final_alignment_rectangle_matrices_NO_global_phase_corr_1en5_delta(small_delta_rectangle):
    ...
    mfile = 'SPmerge02_final_alignment_rectangle_matrices_NO_global_corr_simulated_10_100_1en5_delta.mat'
    mstruct = sio.loadmat('matlab_result/SPmerge02/'+mfile)
    imgtrans0_m = mstruct['it1']
    imgtrans1_m = mstruct['it2']
    imgden0_m = mstruct['id1']
