...
% test applying a preset linear drift
% inds = linspace(-0.5,0.5,size(sMerge.scanLines,1))';
% sMerge.xyLinearDrift = [-0.02 0.15];
...
% end
% scanOr1 = sMerge.scanOr(:,:,1);
% scanOr2 = sMerge.scanOr(:,:,2);
% imgtrans1 = sMerge.imageTransform(:,:,1);
% imgtrans2 = sMerge.imageTransform(:,:,2);
% save('apply_linear_drift_small_delta.mat', 'scanOr1', 'scanOr2', 'imgtrans1', 'imgtrans2');
...
% save('estimated_alignmment_small_delta.mat', 'dxy');
...
% imgtrans1 = sMerge.imageTransform(:,:,1);
% imgtrans2 = sMerge.imageTransform(:,:,2);
% save('apply_estimated_alignment_small_delta.mat', 'imgtrans1', 'imgtrans2');
...
% score = sMerge.linearSearchScore1;
% drifts = [xDrift(xInd) yDrift(yInd)];
% save('linalig_small_delta_index.mat', 'score', 'xInd', 'yInd');
% save('linalig_small_delta_noindex.mat', 'score', 'drifts');
...
% score = sMerge.linearSearchScore2;
% drifts = sMerge.xyLinearDrift;
% save('linalig_small_delta_provide_xycoord.mat', 'score', 'drifts');
