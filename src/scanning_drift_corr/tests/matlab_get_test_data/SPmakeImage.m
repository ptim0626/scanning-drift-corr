...
if nargin == 2
    ...
    indLines = true(1,size(sMerge.scanLines,1));
end
...
% save('SPmakeimage_rotated_sig_count_ang35_simu.mat', 'sig', 'count');
...
save('SPmakeimage_rotated_KDE_sig_count_ang40_simu.mat', 'sig', 'count');


sub = count > 0;
% save('SPmakeimage_sub_ang120_small_delta.mat', 'sub');
